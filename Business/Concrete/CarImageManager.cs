...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        {
            var oldpath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..\\..\\..\\wwwroot")) + _carImageDal.Get(I => I.ImagesId == carImage.ImagesId).ImagePath;
        ...
        {
            return new SuccessDataResult<CarImage>(_carImageDal.Get(I => I.ImagesId == id));
        }

        public IResult Update(IFormFile file, CarImage carImage)
        {
            var oldpath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..\\..\\..\\wwwroot")) + _carImageDal.Get(p => p.ImagesId == carImage.ImagesId).ImagePath;
